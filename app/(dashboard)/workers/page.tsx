...
export default function WorkersPage() {
  return (
    <div className="max-w-[1200px] mx-auto p-8">
      <h1 className="text-[32px] leading-tight font-bold text-pitch-black mb-1">Workers</h1>
      <p className="text-inkwell mb-8">
        Manage test execution workers.
      </p>
      <div className="border border-oatmeal rounded-cards bg-ghost-white p-12 flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-inkwell max-w-xs">
            Workers will appear here once the feature is available.
          </p>
        </div>
      </div>
    </div>
